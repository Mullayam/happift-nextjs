      ...
      <section className="container grid items-center gap-6 pb-8 pt-6 md:py-10">
        <div className="flex max-w-[980px] flex-col items-start gap-2">
          <h1 className="text-3xl font-extrabold leading-tight tracking-tighter sm:text-3xl md:text-5xl lg:text-6xl">
            Welcome to Happift
            <br className="hidden sm:inline" /> Buy & Sell Variety of Gift Cards
            at the cheaper Rates
          </h1>
          <p className="max-w-[700px] text-lg text-slate-700 dark:text-slate-400 sm:text-xl">
            Don&apos;t miss out on savings when you shop on Amazon or Flipkart.
            Buy discounted gift cards from our website and enjoy even more value
            for your money. Or sell your unused cards to declutter and earn some
            cash. It&apos;s easy, safe, and convenient. Try it now.
          </p>
        </div>
          ...
          <div className="mx-auto max-w-screen-xl px-4 py-8 lg:px-6 lg:py-16">
            <div className="max-w-screen-lg text-gray-500 dark:text-gray-400 sm:text-lg">
              ...
              <p className="mb-4 font-light">
                ...
                there&apos;s no better way to do that than with a thoughtful
                gift. Our gift cards are designed to give your loved ones the
                freedom to choose the gift that they want most, without the
                hassle of traditional gift-giving. We work with a variety of
                retailers and merchants to offer a wide range of gift card
                options. Whether you&apos;re looking for a gift card for a
                popular clothing store, a restaurant, or even an experience like
                a spa day or adventure activity, we&apos;ve got you covered. Our
                goal is to make sure that there&apos;s something for everyone,
                no matter their interests or preferences.
              </p>
              <p className="mb-4 font-medium">
                At our website, we pride ourselves on our user-friendly
                interface and top-notch customer service. We want your
                gift-giving experience to be as stress-free as possible, which
                is why we&apos;ve made it easy to purchase, send, and use our
                gift cards. If you ever have any questions or concerns, our
                support team is always ready and willing to help. Thank you for
                choosing our gift card website as your go-to for all your
                gifting needs. We hope to continue to serve you for many years
                to come!
              </p>
              <a
                href="#"
