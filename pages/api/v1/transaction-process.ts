...
import * as _SampleData from "./payment"
...
class DemoApp {
  ...
  public static createTxnTokenwithRequiredParams(): Promise<any> {
    ...
    try {
       ...
       */
      var paymentDetailBuilder: Paytm.PaymentDetailBuilder =
        new Paytm.PaymentDetailBuilder(channelId, orderId, txnAmount, userInfo)
       ...
       * future transactions
       */
      return Paytm.Payment.createTxnToken(paymentDetail).then(function (
        response
      ) {
  ...
  public static createTxnTokenwithPaytmSSotokenAndPaymentMode(): Promise<any> {
    ...
    try {
      ...
      var enablePaymentMode: Array<object> =
        _SampleData.SampleData.getEnablePaymentModes()
      ...
      var disablePaymentMode: Array<object> =
        _SampleData.SampleData.getdisablePaymentModes()
  ...
  public static createTxnTokenwithAllParams(): Promise<any> {
    ...
    try {
      ...
      var cardTokenRequired: string =
        _SampleData.SampleData.getCardTokenRequired()
  ...
  public static getPaymentStatus(): Promise<any> {
    ...
    try {
      ...
      var paymentStatusDetailBuilder: Paytm.PaymentStatusDetailBuilder =
        new Paytm.PaymentStatusDetailBuilder(orderId)
  ...
  public static initiateRefund(): Promise<any> {
    ...
    try {
      ...
      var refund: Paytm.RefundDetailBuilder = new Paytm.RefundDetailBuilder(
        orderId,
        refId,
        txnId,
        txnType,
       ...
       */
      return Paytm.Refund.initiateRefund(refundDetail).then(function (
        response
      ) {
        if (response instanceof Paytm.SDKResponse) {
          console.log("\nRaw Response:\n", response.getJsonResponse())
  ...
  public static getRefundStatus(): Promise<any> {
    ...
    try {
       ...
       */
      var refundStatusDetailBuilder: Paytm.RefundStatusDetailBuilder =
        new Paytm.RefundStatusDetailBuilder(orderId, refId)
       ...
       */
      return Paytm.Refund.getRefundStatus(refundStatusDetail).then(function (
        response
      ) {
        if (response instanceof Paytm.SDKResponse) {
          console.log("\nRaw Response:\n", response.getJsonResponse())
