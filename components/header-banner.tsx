...
export default function HeaderBanner() {
  return (
    <div
      id="banner"
      className="fixed z-50 flex w-full items-start justify-between gap-8 border border-gray-200 bg-gray-50 px-4 py-3 dark:border-gray-700 dark:bg-gray-800 sm:items-center lg:py-4"
    >
