...
export function SiteFooter() {
  return (
    <footer className="container">
      <div className="flex flex-col items-center justify-between gap-6 border-t border-t-slate-200 py-10 dark:border-t-slate-700 md:h-24 md:flex-row md:py-0">
        <div className="flex flex-col items-center gap-4 px-8 md:flex-row md:gap-2 md:px-0">
          <Icons.logo className="h-6 w-6" />
          <p className="text-center text-sm leading-loose text-slate-600 dark:text-slate-400 md:text-left">
            Happift - All Right Reserved {"  Powered By "}
            <a
            ...
            . UI- shadcn{" "}
            <a
              href="https://github.com/Mullayam/happift-nextjs"
              target="_blank"
              rel="noreferrer"
              className="font-medium underline underline-offset-4"
            >
    ...
    <footer className="bg-white p-4 dark:bg-gray-800 md:p-8 lg:p-10">
      <div className="mx-auto max-w-screen-xl text-center">
        ...
        <p className="my-6 text-gray-500 dark:text-gray-400">
          Looking for a versatile gift? Our gift cards are the answer! They can
          be used to purchase anything from our store, so the recipient can get
          exactly what they want.
        </p>
        <ul className="mb-6 flex flex-wrap items-center justify-center text-gray-900 dark:text-white">
          <li>
            <Link href="/n/about" className="mr-4 hover:underline md:mr-6 ">
              About
            </Link>
          </li>
          ...
          <li>
            <Link href="/n/faqs" className="mr-4 hover:underline md:mr-6">
              FAQs
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link href="/n/contact-us" className="mr-4 hover:underline md:mr-6">
              Contact
            </Link>
          </li>
        </ul>
