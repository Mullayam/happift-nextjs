      ...
      <nav className="border-gray-200 bg-white px-4 py-2.5 dark:bg-gray-800 lg:px-6">
        <div className="flex flex-wrap items-center justify-between">
            ...
            <form action="#" method="GET" className="hidden lg:block lg:pl-2">
              ...
              <div className="relative mt-1 lg:w-96">
                ...
                <input
                  ...
                  name="email"
                  id="topbar-search"
                  className="focus:ring-primary-500 focus:border-primary-500 dark:focus:ring-primary-500 dark:focus:border-primary-500 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 pl-10 text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 sm:text-sm"
                  placeholder="Search"
                />
              </div>
            </form>
          ...
          <div className="flex items-center lg:order-2">
            <button
              type="button"
              className="bg-primary-700 hover:bg-primary-800 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 mr-2 hidden items-center justify-center rounded-lg px-3 py-1.5 text-xs font-medium text-white focus:outline-none focus:ring-4 sm:inline-flex"
            >
              <svg
                aria-hidden="true"
